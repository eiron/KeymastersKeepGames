...
class JustDanceGame(Game):
    ...
    def songs_just_dance_2022(self) -> List[str]:
        return [
            "Bakermat - Baianá [Just Dance 2022]",
            "Imagine Dragons - Believer [Just Dance 2022]",
            "aespa - Black Mamba [Just Dance 2022]",
            "BLACKPINK - BOOMBAYAH [Just Dance 2022]",
            "Doja Cat - Boss Witch [Just Dance 2022]",
            "Bella Poarch - Build A B**** [Just Dance 2022]",
            "The Pussycat Dolls ft. Snoop Dogg - Buttons [Just Dance 2022]",
            "El Chombo - Chacarron [Just Dance 2022]",
            "Sia - Chandelier [Just Dance 2022]",
            "Camila Cabello - Don't Go Yet [Just Dance 2022]",
            "Pabllo Vittar ft. Charli XCX - Flash Pose [Just Dance 2022]",
            "Gala - Freed from Desire [Just Dance 2022]",
            "Meghan Trainor - Funk [Just Dance 2022]",
            "Black Eyed Peas & Shakira - GIRL LIKE ME [Just Dance 2022]",
            "Olivia Rodrigo - good 4 u [Just Dance 2022]",
            "Billie Eilish - Happier Than Ever [Just Dance 2022]",
            "Sevdaliza - Human [Just Dance 2022]",
            "Anastacia - I'm Outta Love [Just Dance 2022]",
            "Master KG ft. Nomcebo Zikode - Jerusalema [Just Dance 2022]",
            "SuperM - Jopping [Just Dance 2022]",
            "Lady Gaga - Judas [Just Dance 2022]",
            "Katy Perry - Last Friday Night (T.G.I.F.) [Just Dance 2022]",
            "Ciara - Level Up [Just Dance 2022]",
            "Dua Lipa - Levitating [Just Dance 2022]",
            "Taylor Swift - Love Story (Taylor's Version) [Just Dance 2022]",
            "24kGoldn ft. Iann Dior - Mood [Just Dance 2022]",
            "Electric Light Orchestra - Mr. Blue Sky [Just Dance 2022]",
            "Domino Saints - My Way [Just Dance 2022]",
            "Todrick Hall - Nails, Hair, Hips, Heels [Just Dance 2022]",
            "K/DA - POP/STARS [Just Dance 2022]",
            "Zara Larsson - Poster Girl [Just Dance 2022]",
            "Justin Timberlake - Rock Your Body [Just Dance 2022]",
            "Beyoncé - Run the World (Girls) [Just Dance 2022]",
            "The Weeknd & Ariana Grande - Save Your Tears (Remix) [Just Dance 2022]",
            "Bronski Beat - Smalltown Boy [Just Dance 2022]",
            "Ayo & Teo - Stop Drop Roll [Just Dance 2022]",
            "Major Lazer ft. Anitta & Pabllo Vittar - Sua Cara [Just Dance 2022]",
            "Daði Freyr - Think About Things [Just Dance 2022]",
            "Chilly Gonzales - You Can Dance [Just Dance 2022]",
            "Sylvester - You Make Me Feel (Mighty Real) [Just Dance 2022]",
        ]
    ...
    def songs_just_dance_2026(self) -> List[str]:
        return [
            ...
            "Houdini - Dua Lipa",
            "Hung Up - Madonna",
            # Additional songs to be revealed closer to release
        ]

...
class OneStepFromEdenGame(Game):
    ...
    def optional_game_constraint_templates(self) -> List[GameObjectiveTemplate]:
        return [
            GameObjectiveTemplate(label="Win a run without equipping any artifacts", data={}, is_time_consuming=False, is_difficult=True),
            GameObjectiveTemplate(label="Win a run without removing any spells", data={}, is_time_consuming=False, is_difficult=True),
            GameObjectiveTemplate(label="Win a run without taking any mana upgrades", data={}, is_time_consuming=False, is_difficult=True),
            GameObjectiveTemplate(label="Win a run while keeping your starter loadout", data={}, is_time_consuming=False, is_difficult=True),
            GameObjectiveTemplate(label="Win a run without visiting shops", data={}, is_time_consuming=False, is_difficult=True),
            GameObjectiveTemplate(label="Win a run without buying any upgrades from shops", data={}, is_time_consuming=False, is_difficult=True),
            GameObjectiveTemplate(label="Win a run without buying spell removes from shops", data={}, is_time_consuming=False, is_difficult=True),
            GameObjectiveTemplate(label="Win a run while skipping all treasure room artifacts", data={}, is_time_consuming=False, is_difficult=True),
            GameObjectiveTemplate(label="Win a run while picking every self-damaging spell offered", data={}, is_time_consuming=False, is_difficult=True),
            GameObjectiveTemplate(label="Win a run using only spells of 2 cost or less", data={}, is_time_consuming=False, is_difficult=True),
            GameObjectiveTemplate(label="Win a run with 5 or fewer spells in your deck", data={}, is_time_consuming=False, is_difficult=True),
            GameObjectiveTemplate(label="Win a run after rescuing every NPC you find", data={}, is_time_consuming=False, is_difficult=False),
            GameObjectiveTemplate(label="Win a run after removing every starter spell", data={}, is_time_consuming=False, is_difficult=False),
            GameObjectiveTemplate(label="Win a run without picking up any Legendary or Calamity spells", data={}, is_time_consuming=False, is_difficult=True),
            GameObjectiveTemplate(label="Win a run after upgrading a single spell at least 4 times", data={}, is_time_consuming=False, is_difficult=False),
            GameObjectiveTemplate(label="Win a run without upgrading any spell more than once", data={}, is_time_consuming=False, is_difficult=False),
            GameObjectiveTemplate(label="Win a run after defeating every boss you encounter", data={}, is_time_consuming=False, is_difficult=True),
            GameObjectiveTemplate(label="Route through every miniboss you see and win", data={}, is_time_consuming=False, is_difficult=True),
            GameObjectiveTemplate(label="Enter every Hazard room you see and win", data={}, is_time_consuming=False, is_difficult=True),
            GameObjectiveTemplate(label="Kill 5 bunnies (visit at least 5 campfires) and win the run", data={}, is_time_consuming=False, is_difficult=False),
            GameObjectiveTemplate(label="On floor 1, pick the path with the most combat rooms", data={}, is_time_consuming=False, is_difficult=True),
            GameObjectiveTemplate(label="Pacifist every world except bosses and still win", data={}, is_time_consuming=False, is_difficult=True),
        ]

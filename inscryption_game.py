...
class InscryptionGame(Game):
    ...
    def optional_game_constraint_templates(self) -> List[GameObjectiveTemplate]:
        return [
            GameObjectiveTemplate(label="Use only a single tribe throughout the run", data={"TRIBE": (self.card_tribes, 1)}, is_time_consuming=False, is_difficult=True),
            GameObjectiveTemplate(label="Never use items during battles", data={}, is_time_consuming=False, is_difficult=True),
            GameObjectiveTemplate(label="Win all battles without losing a life", data={}, is_time_consuming=False, is_difficult=True),
            GameObjectiveTemplate(label="Never merge or upgrade cards", data={}, is_time_consuming=False, is_difficult=True),
            GameObjectiveTemplate(label="Never restart a battle", data={}, is_time_consuming=False, is_difficult=False),
            GameObjectiveTemplate(label="Defeat the final boss with only 1 card in deck", data={}, is_time_consuming=False, is_difficult=True),
            GameObjectiveTemplate(label="Build a deck using only cards with the Unkillable sigil", data={}, is_time_consuming=False, is_difficult=True),
            GameObjectiveTemplate(label="Never sacrifice creatures (blood cost only allowed)", data={}, is_time_consuming=False, is_difficult=True),
            GameObjectiveTemplate(label="Complete the run using cards from only one Scrybe", data={"SCRYBE": (self.scrybes, 1)}, is_time_consuming=False, is_difficult=True),
            GameObjectiveTemplate(label="Buy the Trapper's skinning knife", data={}, is_time_consuming=False, is_difficult=False),
            GameObjectiveTemplate(label="Take at least three copies of the same card", data={}, is_time_consuming=False, is_difficult=False),
            GameObjectiveTemplate(label="Buy a golden pelt", data={}, is_time_consuming=False, is_difficult=False),
            GameObjectiveTemplate(label="Fail the Cave Trial at least 3 times", data={}, is_time_consuming=False, is_difficult=False),
            GameObjectiveTemplate(label="Never finish creating a totem", data={}, is_time_consuming=False, is_difficult=True),
            GameObjectiveTemplate(label="Avoid all regular card draft spots", data={}, is_time_consuming=False, is_difficult=True),
            GameObjectiveTemplate(label="Finish the run with a card that has no added sigils", data={}, is_time_consuming=False, is_difficult=False),
            GameObjectiveTemplate(label="Visit every Mycologist available", data={}, is_time_consuming=False, is_difficult=False),
            GameObjectiveTemplate(label="Paint a card with no added sigils", data={}, is_time_consuming=False, is_difficult=False),
        ]
